...
class Job2Tests {
	...
	Job2Tests(@Autowired JobLauncher jobLauncher, @Autowired JobRepository jobRepository, @Autowired Job job2) {
	...
	void test() throws Exception {
		...
		then(jobExecution) //
			...
			.returns("step2", from(StepExecution::getStepName))
